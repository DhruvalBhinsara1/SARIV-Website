...
export async function POST(req: Request) {
  try {
          ...
          <div style="max-width: 600px; margin: 0 auto; background-color: #FFFFFF; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.04);">
            ...
            <div style="padding: 32px;">
              ...
              <p style="font-size: 16px; color: #555555; line-height: 1.5; margin: 0 0 24px;">
                You've received a new contact inquiry from <strong>${name}</strong>.
              </p>
              ...
              <div style="background-color: #FAF9F7; border-radius: 8px; padding: 24px; margin-bottom: 32px;">
                ...
                <div style="margin-top: 16px;">
                  <p style="color: #8A8A8A; font-size: 14px; margin: 0 0 8px;">Message</p>
                  <p style="font-size: 15px; color: #111111; line-height: 1.6; margin: 0; white-space: pre-wrap;">${message}</p>
                </div>
              </div>
    ...
    await transporter.sendMail({
      from: process.env.SMTP_EMAIL,
      to: email,
      subject: `Thanks for reaching out to SARIV`,
        ...
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background-color: #FAF9F7; padding: 40px 20px; color: #111111;">
          <div style="max-width: 600px; margin: 0 auto; background-color: #FFFFFF; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.04);">
            ...
            <div style="padding: 32px;">
              ...
              <p style="font-size: 16px; color: #555555; line-height: 1.5; margin: 0 0 24px;">
                Thanks for reaching out to us. We just wanted to let you know that we've received your message!
              </p>
              <p style="font-size: 16px; color: #555555; line-height: 1.5; margin: 0 0 24px;">
                One of our team members is reviewing it and will get back to you shortly.
              </p>
