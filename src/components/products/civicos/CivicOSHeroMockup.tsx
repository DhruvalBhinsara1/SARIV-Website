...
export function CivicOSHeroMockup() {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full bg-surface-elevated border border-border rounded-2xl overflow-hidden p-2 md:p-3 shadow-elevation">
        <div className="relative w-full rounded-xl overflow-hidden border border-border/50 bg-[#0a0a0a] aspect-[16/10]">
          <Image
            ...
            alt="CivicOS Municipal Command Center and Live GIS Dispatch Map"
            fill
      ...
      <div className="absolute -bottom-6 -right-2 md:-bottom-10 md:-right-6 w-[38%] md:w-[32%] aspect-[9/18.5] bg-[#0E0E10] border-2 border-white/20 rounded-[1.75rem] md:rounded-[2.25rem] overflow-hidden p-1.5 md:p-2 shadow-2xl shadow-black/80 z-20 transition-transform duration-500 hover:scale-[1.03]">
